...
export const modules = [
  {
    ...
    lesson: [
      ...
      {
        heading: "Deep dive — a day on site, impact by impact",
        body: "Follow one ordinary working day and watch the impacts appear. This is how an ESG eye reads a site:",
        points: [
          "06:30 — generators start: fuel use, exhaust and noise for the nearest homes (E + S).",
          "08:00 — the batching plant runs: cement dust drifts with the wind; washout water must go to the lined pit, never the drain (E).",
          "10:00 — twelve trucks pass through the village: speed, dust and children walking to school — the traffic plan is the control (S).",
          "13:00 — lunch for 300 workers: food waste and packaging need bins and collection, or the community lives with the litter (E + S).",
          "17:30 — refuelling the excavators: the highest spill-risk moment of the day; drip trays and a spill kit within reach (E).",
          "18:00 — the supervisor logs it all: near-misses, complaints, waste volumes — tomorrow's KPIs are born tonight (everything).",
        ],
        image: "/images/lm9.jpg",
        caption: "One ordinary day = a dozen impacts, each with a simple control.",
      },
    ],
    objectives: [
  ...
  },
  {
    ...
    lesson: [
      ...
      {
        heading: "Deep dive — the life of a permit",
        body: "A permit is not a certificate to frame — it is a living obligation. Every permit on the project follows the same life:",
        points: [
          "1 · Apply — with studies attached; the regulator can take months, so late applications stall works.",
          "2 · Receive conditions — a discharge permit says WHAT you may release, HOW MUCH, WHERE and HOW OFTEN you must test.",
          "3 · Display & brief — the site team must know the limits; a permit nobody has read protects nobody.",
          "4 · Monitor & record — sampling results and volumes go into the register; this is what NESREA and the IESC inspect.",
          "5 · Renew BEFORE expiry — an expired permit means illegal operation from day one, even if nothing changed on the ground.",
          "Example: a borrow pit permitted for 50,000 m³ that reaches 50,001 m³ is in breach — quantity limits are as binding as quality limits.",
        ],
        image: "/images/lm12.jpg",
        caption: "Apply → conditions → brief the team → monitor → renew before expiry.",
      },
    ],
    objectives: [
